...
# The goal of this presentation is to show that 80-90% of traditional UIs will someday be replaced by wordclouds
...
<CodeSurfer
  ...
  steps={[
    ...
    },
    {
      ...
      notes: () => (
        <span>
          Here's the render method of the component, we just need to add transitions
        </span>
      )
    },
    {
