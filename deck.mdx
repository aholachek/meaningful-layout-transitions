...
2. Declarative nature of virtual DOM (especially relevant for exit & update animations)
3. Inherent complications of web layouts (z-index, nested transforms...)
...
2. Flexible
3. Scale cancellation
4. Facilitates separation of components
5. Easy, spring-based animations and staggers
