...
<a href="https://github.com/aholachek/react-flip-toolkit">
  <img
    style={{ width: "600px", margin: "6rem auto 0 auto" }}
...
# Enter, Exit and Update Transitions
...
# Complex FLIP animations made simple(r)
...
<CodeSurfer
  ...
  steps={[
    { range: [58, 99], notes: ()=> <span>The cascading staggered animations are accomplished with nested <code>Flipped</code> components.</span>},
]}
/>
